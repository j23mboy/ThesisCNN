...
C = models.vgg16(pretrained=True)
...
# 訓練完成後儲存模型的路徑
model_save_path = 'D:/模型儲存/VGG16_model.pth'
...
if __name__ == '__main__':
    ...
    # 保存混淆矩陣圖
    conf_matrix_pic_name = 'VGG16_confusion_matrix_' + time.strftime("%Y%m%d", time.localtime()) + '.png'
...
loss_pic_name = 'VGG16_loss_' + now + '.png'
plt.figure()
...
acc_pic_name = 'VGG16_acc_' + now + '.png'
plt.figure()
